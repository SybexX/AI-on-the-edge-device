...
// interface_mqtt + read_networkini
...
*/
// #define WIFI_USE_MESH_ROAMING   // 802.11v (BSS Transition Management) + 802.11k (Radio Resource Management) (ca. 6kB - 8kB internal RAM neccessary)
// #define WIFI_USE_MESH_ROAMING_ACTIVATE_CLIENT_TRIGGERED_QUERIES  // Client can send query to AP requesting to roam (if RSSI lower than RSSI threshold)
...
#define WIFI_USE_ROAMING_BY_SCANNING
...
// SPI_ETHERNET_W5500
//-------------------------------------------------
#define PER_ENABLE GPIO_NUM_46 // activates power for camera, leds, and SDcard and Battery measurement voltage divider
#define ETH_SPI_EN GPIO_NUM_45 // activates power for the Ethernet
