...
esp_err_t send_file(httpd_req_t *req, std::string filename)
{
    ...
    if (endsWith(filename, ".html") || endsWith(filename, ".htm") || endsWith(filename, ".xml") || endsWith(filename, ".css") || 
        ...
        endsWith(filename, ".ico") || endsWith(filename, ".png") || endsWith(filename, ".gif") || endsWith(filename, ".gz")) {
...
std::string unzip_ota(std::string _in_zip_file, std::string _html_tmp, std::string _html_final, std::string _target_bin, std::string _main, bool _initial_setup)
{
    mzip_bool status;
    size_t uncomp_size;
