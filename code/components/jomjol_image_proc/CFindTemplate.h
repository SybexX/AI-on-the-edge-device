...
struct RefInfo
{
    ...
    int search_x = 0;              // X-size (width) in which the reference is searched
    int search_y = 0;              // Y-size (height) in which the reference is searched
    float search_max_angle = 0.0f; // Max rotation angle in which the reference is searched
    int found_x = 0;
    int found_y = 0;
    int fastalg_x = -1;
    int fastalg_y = -1;
